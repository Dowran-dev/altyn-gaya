...
//   // Mock related products data (updated to match new Product interface)
//   const relatedProducts = [
//     {
//       title: "Real Plus Чистое и уютное масло RX",
//       description: "Продукт премиум-класса для готовки и улучшения вкуса.",
//       image: "/images/real-plus-1.jpg",
//       color: "Natural",
//       brandName: "Real Plus",
//       category: "Cooking",
//       features: [],
...
//         fullTitle: "Real Plus Чистое и уютное масло RX",
//         description: "Продукт премиум-класса для готовки и улучшения вкуса.",
//         longDescription: "",
//         image: "/images/real-plus-1.jpg",
//         color: "Natural",
...
//   if (loading) {
//     return (
//       <div className="container mx-auto max-w-6xl px-3 sm:px-4 py-4 sm:py-6 flex justify-center items-center h-64">
...
//           <span className="text-gray-500 ml-1">{product.details.name}</span>
//         </div>
//       </div>

//       <div className="flex flex-col md:grid md:grid-cols-2 md:gap-8">
//         <div className="relative rounded-xl overflow-hidden aspect-square mb-4 md:mb-0">
//           <Image
...
//             <span className="absolute top-2 left-2 text-xs font-medium px-2 py-1 rounded-full bg-orange-100 text-orange-500">
//               {product.details.badge}
//             </span>
//           )}
//         </div>
...
//                 <span className="ml-1">{product.details.reviews} отзывов</span>
//               </div>
//             </div>
//             <h1 className="text-xl sm:text-2xl font-bold text-blue-900 mb-2">{product.details.name}</h1>
//             <p className="text-xs sm:text-sm text-gray-600">{product.details.description}</p>
//           </div>

//           <div className="mb-4 sm:mb-6">
//             <h3 className="text-xs sm:text-sm font-medium mb-2 text-gray-700">Доступные размеры</h3>
//             <div className="flex overflow-x-auto pb-2 gap-2 no-scrollbar">
//               {product.details.sizes.map((size) => (
//                 <span
//                   key={size.id}
//                   className="px-3 py-1 rounded-full text-xs whitespace-nowrap bg-blue-50 text-blue-800"
//                 >
...
//           <div className="mb-4 sm:mb-6">
//             <h3 className="text-xs sm:text-sm font-medium mb-2 text-gray-700">Основные характеристики</h3>
//             <ul className="text-xs text-gray-600 space-y-1">
//               {product.details.features.slice(0, 3).map((feature, index) => (
//                 <li key={index} className="flex items-center">
//                   <span className="min-w-1 h-1 bg-blue-800 rounded-full mr-2"></span>
//                   {feature}
//                 </li>
//               ))}
//               {product.details.features.length > 3 && (
//                 <li className="text-blue-800 cursor-pointer hover:underline">+ Дополнительные характеристики</li>
//               )}
//             </ul>
//           </div>

//           <div className="sm:mt-auto">
//             <button className="fixed bottom-0 left-0 right-0 z-10 sm:relative sm:z-0 bg-orange-500 text-white px-6 py-3 sm:py-2 hover:bg-orange-600 transition-colors font-bold text-sm flex items-center justify-center gap-2 sm:rounded-full">
...
//           <summary className="flex items-center justify-between cursor-pointer text-blue-900 font-medium text-sm sm:text-base px-1">
//             Описание продукта
...
//             </span>
//           </summary>
//           <p className="text-xs sm:text-sm text-gray-700 pt-2 px-1">{product.details.longDescription}</p>
//         </details>
...
//             </span>
//           </summary>
//           <ul className="text-xs sm:text-sm text-gray-600 pt-2 space-y-1 pl-5 list-disc">
...
//             {product.details.reviewsList.slice(0, 2).map((review) => (
//               <div key={review.id} className="border-b border-gray-200 pb-4">
//                 <div className="flex items-center mb-1">
//                   {renderRatingStars(review.rating)}
//                   <span className="ml-2 text-xs text-gray-500">{review.date}</span>
//                 </div>
//                 <h4 className="text-xs sm:text-sm font-medium text-blue-900">{review.title}</h4>
//                 <p className="text-xs text-gray-600">{review.content}</p>
//                 <p className="text-xs text-gray-500 mt-1">— {review.author}</p>
//               </div>
//             ))}
//             {product.details.reviewsList.length > 2 && (
//               <button className="text-xs text-blue-800 hover:underline">Посмотреть все отзывы</button>
//             )}
//           </div>
//         </details>
//       </div>
...
//       <div className="mt-8">
//         <h2 className="text-xl font-bold text-blue-900 mb-4">Похожие продукты</h2>
//         <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6">
//           {relatedProducts.map((relatedProduct) => (
//             <div
//               key={relatedProduct.details.id}
...
//                 <Image
//                   src={relatedProduct.details.image}
//                   alt={relatedProduct.details.name}
//                   layout="fill"
//                   objectFit="contain"
//                   className="p-4"
//                 />
//                 <span className="absolute top-2 right-2 text-xs font-medium px-2 py-1 rounded-full bg-purple-600 text-white">
//                   {relatedProduct.details.badge}
//                 </span>
//               </div>

//               <div className="p-4 flex flex-col justify-between flex-grow">
//                 <div>
//                   <h3 className="text-sm font-bold text-blue-900 mb-1">{relatedProduct.details.name}</h3>
//                   <div className="flex items-center text-gray-500 text-xs mb-2">
//                     {renderRatingStars(relatedProduct.details.rating)}
//                     <span className="ml-1">({relatedProduct.details.reviews})</span>
//                   </div>
//                 </div>
//                 <button className="bg-orange-500 text-white px-4 py-2 rounded-full hover:bg-orange-600 transition-colors font-bold text-sm">
//                   Найти магазины
//                 </button>
//               </div>
//             </div>
...
//                 <span className="ml-1">{product.reviews} отзывов</span>
//               </div>
//             </div>
//             <h1 className="text-xl sm:text-2xl font-bold text-blue-900 mb-2">{product.name}</h1>
//             <p className="text-xs sm:text-sm text-gray-600">{product.description}</p>
//           </div>

//           {/* Sizes - Scroll horizontally on mobile */}
//           <div className="mb-4 sm:mb-6">
//             <h3 className="text-xs sm:text-sm font-medium mb-2 text-gray-700">Доступные размеры</h3>
//             <div className="flex overflow-x-auto pb-2 gap-2 no-scrollbar">
...
//             </span>
//           </summary>
//           <p className="text-xs sm:text-sm text-gray-700 pt-2 px-1">{product.longDescription}</p>
//         </details>
...
//               <div className="p-4 flex flex-col justify-between flex-grow">
//                 <div>
//                 <h3 className="text-sm font-bold text-blue-900 mb-1">{relatedProduct.name}</h3>
//                 <div className="flex items-center text-gray-500 text-xs mb-2">
//                   {renderRatingStars(relatedProduct.rating)}
//                   <span className="ml-1">({relatedProduct.reviews})</span>
//                 </div>
//                 </div>
//                 {/* <p className="text-xs text-gray-600 mb-4 flex-grow">{relatedProduct.description}</p> */}
//                 <button className="bg-orange-500 text-white px-4 py-2 rounded-full hover:bg-orange-600 transition-colors font-bold text-sm">
//                   Найти магазины
//                 </button>
//               </div>

...
//               <ul className="space-y-3">
//                 <li><a href="news-page" className="text-white/70 hover:text-[#fb4b06] transition-colors">Новости</a></li>
//                 <li><a href="faq" className="text-white/70 hover:text-[#fb4b06] transition-colors">FAQ</a></li>
//                 <li><a href="contacts-page" className="text-white/70 hover:text-[#fb4b06] transition-colors">Контакты</a></li>
//               </ul>
//             </div>
...
export default function Footer() {
  const t = useTranslations(); // Use useTranslations to fetch translation strings
  const [categories, setCategories] = useState<string[]>([]);
    ...
    <>
      <footer className="bg-[#0a0d42] py-12 text-white relative overflow-hidden">
        <div className="container mx-auto px-4 relative z-10">
          <div className="grid md:grid-cols-4 gap-8">
            <div>
              <h4 className="text-xl font-bold mb-6">{t("footer.aboutUs")}</h4>
              <ul className="space-y-3">
                <li><a href="#" className="text-white/70 hover:text-[#fb4b06] transition-colors">{t("footer.history")}</a></li>
                <li><a href="#" className="text-white/70 hover:text-[#fb4b06] transition-colors">{t("footer.missionAndValues")}</a></li>
              </ul>
            </div>
            
            <div>
              <h4 className="text-xl font-bold mb-6">{t("footer.products")}</h4>
              <ul className="space-y-3">
                {/* Dynamically generated category links */}
                {categories.length > 0 ? (
                  categories.map((category, idx) => (
                  ...
                  <li className="text-white/50">{t("footer.loading")}</li>
                )}
              </ul>
            </div>

            <div>
              <h4 className="text-xl font-bold mb-6">{t("footer.information")}</h4>
              <ul className="space-y-3">
                {/* <li><a href="news-page" className="text-white/70 hover:text-[#fb4b06] transition-colors">{t("footer.news")}</a></li> */}
                <li><a href="faq" className="text-white/70 hover:text-[#fb4b06] transition-colors">{t("footer.faq")}</a></li>
                <li><a href="contacts-page" className="text-white/70 hover:text-[#fb4b06] transition-colors">{t("footer.contacts")}</a></li>
              </ul>
            </div>
            
            <div>
              <h4 className="text-xl font-bold mb-6">{t("footer.contacts")}</h4>
              <ul className="space-y-3">
                <li className="flex items-center">
                  <Phone className="w-4 h-4 text-[#fb4b06] mr-2" />
                  <span className="text-white/70">{contactInfo.phone}</span>
                ...
                <li className="flex items-center">
                  <MapPin className="min-w-4 min-h-4 text-[#fb4b06] mr-2" />
          ...
          <div className="mt-12 pt-8 border-t border-white/10 flex flex-col md:flex-row justify-between items-center">
            ...
            <div className="flex space-x-6">
              <a href="#" className="text-white/50 hover:text-[#fb4b06] transition-colors">{t("footer.privacyPolicy")}</a>
              <a href="#" className="text-white/50 hover:text-[#fb4b06] transition-colors">{t("footer.termsOfUse")}</a>
            </div>
          </div>
        </div>
      </footer>

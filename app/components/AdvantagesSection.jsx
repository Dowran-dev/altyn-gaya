...
//           {/* Advantage 1 */}
//           <motion.div
//             className="bg-white rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 overflow-hidden group flex flex-col items-center justify-between"
//             variants={itemVariants}
//           >
...
//               </p>
//             </div>
//             <div className="w-full p-5 md:p-6 bg-gray-50">
  ...
  return (
    <section className="py-16 md:py-24 bg-white dark:bg-gray-900 relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 sm:px-6 relative z-10">
        ...
        {/* CTA Button - Added but commented out as in original */}
        {/* <motion.div
          className="mt-12 md:mt-16 text-center"
          initial={{ opacity: 0, y: 20 }}
          whileInView={{ opacity: 1, y: 0 }}
        ...
        >
          <motion.button
            className="relative overflow-hidden group bg-gradient-to-r from-[#fb4b06] to-[#E85D24] dark:from-[#ff6a2c] dark:to-[#ff7a40] hover:from-[#E85D24] hover:to-[#fb4b06] dark:hover:from-[#ff7a40] dark:hover:to-[#ff6a2c] text-white px-6 sm:px-10 py-3 sm:py-5 text-base sm:text-xl rounded-full font-semibold shadow-lg shadow-[#fb4b06]/20 dark:shadow-[#ff6a2c]/20 hover:shadow-[#fb4b06]/40 dark:hover:shadow-[#ff6a2c]/40 transition-all"
            whileHover={{ scale: 1.05 }}
            whileTap={{ scale: 0.98 }}
          >
            <span className="relative z-10 flex items-center justify-center gap-2 sm:gap-3">

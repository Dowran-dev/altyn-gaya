...
//     <>
//       <header
//         className={`bg-white w-full z-30 fixed top-0 left-0 right-0 transition-all duration-300 ${
//           scrolled ? "shadow-md" : ""
//         }`}
//       >
...
//               {/* Mobile menu button */}
//               <button
//                 className="lg:hidden text-gray-700 hover:text-[#fb4b06] transition-colors"
//                 aria-label="Open menu"
//               >
...
//                 <div className="relative overflow-hidden rounded-full h-8 w-8 lg:h-10 lg:w-10 border border-[#fb4b06]/20">
//                   <Image
//                     src="/image/logo.png"
//                     alt="Altyn Gaya Logo"
//                     layout="fill"
...
//                 <button className="flex items-center text-gray-700 hover:text-[#fb4b06] transition-colors">
//                   <Layers className="w-4 h-4 mr-1.5" />
...
//             {/* Center section - Search */}
//             <div className="hidden md:block max-w-md mx-4 w-full">
//               <div className="relative">
//                 <Input
//                   type="search"
//                   placeholder="Поиск продукции..."
//                   className="pl-9 pr-4 py-1.5 rounded-full border border-gray-200 focus:border-[#fb4b06] bg-gray-50 text-gray-800 text-sm"
//                   value={searchQuery}
//                   onChange={(e) => setSearchQuery(e.target.value)}
//                 />
...
//               {/* Search button (mobile only) */}
//               <button
//                 className="md:hidden p-1.5 text-gray-700 hover:text-[#fb4b06] transition-colors"
//                 onClick={() => setIsSearchOpen(!isSearchOpen)}
//                 aria-label="Search"
//               >
//                 <Search className="w-5 h-5" />
...
//               <Link
//                 href="/wishlist"
//                 className="hidden sm:flex p-1.5 text-gray-700 hover:text-[#fb4b06] transition-colors relative"
//                 aria-label="Wishlist"
//               >
//                 <Heart className="w-5 h-5" />
//                 <span className="absolute -top-1 -right-1 bg-[#fb4b06] text-white text-xs font-bold rounded-full h-4 w-4 flex items-center justify-center">
...
//               <Link
//                 href="/cart"
//                 className="p-1.5 text-gray-700 hover:text-[#fb4b06] transition-colors relative"
//                 aria-label="Cart"
//               >
//                 <ShoppingCart className="w-5 h-5" />
//                 <span className="absolute -top-1 -right-1 bg-[#fb4b06] text-white text-xs font-bold rounded-full h-4 w-4 flex items-center justify-center">
...
//               <Link
//                 href="/account"
//                 className="p-1.5 text-gray-700 hover:text-[#fb4b06] transition-colors"
...
//         {/* Mobile search overlay */}
//         {isSearchOpen && (
//           <div className="absolute top-full left-0 w-full bg-white shadow-md border-t border-gray-100 p-3 z-20">
//             <form onSubmit={handleSearch} className="relative">
//               <Input
//                 type="search"
//                 placeholder="Поиск продукции..."
//                 className="pl-9 pr-8 py-1.5 rounded-full border border-gray-200 focus:border-[#fb4b06] text-sm bg-gray-50"
//                 value={searchQuery}
//                 onChange={(e) => setSearchQuery(e.target.value)}
//               />
//               <Search className="absolute left-3 top-1/2 -translate-y-1/2 h-4 w-4 text-gray-400" />
...
const Header = () => {
  ...
  const navItems = [
    ...
    { name: "FAQ", href: "/faq" },
    { name: "Контакты", href: "/contacts-us" },
  ];

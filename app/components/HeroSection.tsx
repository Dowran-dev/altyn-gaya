    ...
    <section className="relative min-h-[90vh] flex items-center overflow-hidden bg-black">
      ...
      <div className="container mx-auto px-4 py-8 md:py-12 z-10 relative">
        <div className="max-w-xl md:max-w-2xl">
          ...
          <div className="mb-8 md:mb-16">
            <div className="inline-block py-1 px-4 md:py-2 md:px-6 bg-white/5 backdrop-blur-md rounded-full mb-6 md:mb-8">
              ...
              <span className="text-gray-300 text-sm md:text-lg">С 2008 года</span>
            </div>
          </div>
          ...
          <div className="space-y-6 md:space-y-10">
            <div className="overflow-hidden">
              ...
              >
                <span className="inline-block">Чистота</span>
                <span className="inline-block ml-2 md:ml-4">и</span>
                <span className="inline-block text-[#fb4b06] ml-2 md:ml-4">комфорт</span>
              </h1>
        ...
        <div 
          ...
          onClick={handleScrollDown}
        >
          <div className="text-white text-opacity-80 text-sm md:text-base mb-1 md:mb-2">Узнать больше</div>
